...
const HowItWorks = () => {
  ...
  const steps = [
    {
      ...
      description:
        "Para ter acesso as nossas funcionalidades, precisa de poucos dados, apenas o seu nome, email e uma senha.",
      icon: <User className="size-10"/>,
    },
    {
      title: "Adicione suas transações",
      description:
        "Adicione despesas ou receitas com seus diferentes métodos de pagamento de forma rápida e fácil.",
      icon: <BadgeDollarSign className="size-10" />,
    },
    {
      title: "Acompanhe seus resultados",
      description:
        "Visualize sua vida financeira em um dashboard completo de gráficos categorizados com insights valiosos.",
  ...
  return (
    <section id="how-it-works" className="w-full h-screen p-20">
      <BlurFade
        className="w-full h-full flex flex-col items-center justify-center mx-auto"
        delay={BLUR_FADE_TIME}
        duration={BLUR_FADE_TIME}
        inView
      >
        <div className="text-center mb-16">
          <p className="text-lg text-muted-foreground tracking-widest">COMO FUNCIONA</p>
